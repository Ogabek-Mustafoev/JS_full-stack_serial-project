...
function classes() {
  ...
  var MenuCard = /*#__PURE__*/function () {
    function MenuCard(srs, alt, title, desc, price, parentSelector) {
  ...
  axios.get("http://localhost:3000/menu").then(function (data) {
    data.data.map(function (_ref) {
      var img = _ref.img,
        ...
        descr = _ref.descr,
        price = _ref.price;
      new MenuCard(img, altImg, subs, descr, price, ".menu .container").render();
    });
  });
  /* jshint ignore:end */
}
...
function form(formSelector, modalTimerId) {
  ...
  function bindPostData(form) {
    form.addEventListener("submit", function (e) {
      ...
      (0,_server_server__WEBPACK_IMPORTED_MODULE_10__.postData)("http://localhost:3000/request", json).then(function () {
  ...
  function showThanksModal(message) {
    ...
    var thansModal = document.createElement("div");
...
function slider(_ref) {
  ...
  next.addEventListener("click", function () {
    ...
    slidesField.style.transform = "translateX(-".concat(fixedOfst(offset), "px)");
...
function timer(id, deadline) {
  ...
  function setClock(selector, endTime) {
    ...
    function updateClock() {
      var allTime = getTimeRemaining(endTime);
...
/* harmony import */ var _modules_tab__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../modules/tab */ "./src/modules/tab.js");
/* harmony import */ var _modules_timer__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../modules/timer */ "./src/modules/timer.js");
...
window.addEventListener("DOMContentLoaded", function () {
  ...
  var deadline = "".concat(new Date().getFullYear() + 1, "-01-01");
  (0,_modules_class__WEBPACK_IMPORTED_MODULE_2__["default"])();
  ...
  (0,_modules_tab__WEBPACK_IMPORTED_MODULE_7__["default"])(".tabheader__item", ".tabcontent", "tabheader__item_active");
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_8__["default"])(".timer", deadline);
});
})();
